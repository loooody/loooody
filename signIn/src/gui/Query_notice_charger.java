...
//	private static Query_salary_employee query_salary ;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Query_notice_charger frame = new Query_notice_charger();
	 ...
	 */
	public Query_notice_charger() throws ClassNotFoundException, SQLException {
